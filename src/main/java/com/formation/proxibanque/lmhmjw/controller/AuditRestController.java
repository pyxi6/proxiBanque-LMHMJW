...
public class AuditRestController {
	...
	@GetMapping(path = "/directeur/tauxOccupation/{id}")
	public double GetTauxOccupationParConseiller(@PathVariable Long id) {
		return auditService.getNombreClientParConseiller(id)*10;
	}
